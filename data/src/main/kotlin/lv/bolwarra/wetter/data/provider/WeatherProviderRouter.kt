...
import lv.bolwarra.wetter.data.BuildConfig
 ...
 */
internal class WeatherProviderRouter(
    ...
    private suspend fun extendIfShort(
        ...
        log(
            "${forecast.provider.id} is hourly for ${coveredHours}h; extending with ${candidate.id}",
        )
